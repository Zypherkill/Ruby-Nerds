Fråga 1: Skillnaden som vi sett från start är att Aizo har fler spärrar, han ställer frågor och vill att man själv ska tänka medans ChatGPT ger ut direkt svar på hur den applicerar metoderna på spelet.
